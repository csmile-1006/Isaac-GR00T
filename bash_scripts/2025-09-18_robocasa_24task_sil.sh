#!/bin/bash                                                                                                                                                  
#SBATCH --job-name=sil_gr00tn15_rc_24
#SBATCH --output=/home/changyeon/slurm-logs/sil_gr00tn15_rc_24/%j.out  # log                                                                                                   
#SBATCH --error=/home/changyeon/slurm-logs/sil_gr00tn15_rc_24/%j.err   # log                                                                                                   
...
TASK_NAMES=(
    ...
    "PnPCounterToSink,228",
    "PnPCounterToStove,156",
    "PnPMicrowaveToCounter,73",
    "PnPSinkToCounter,185",
    "PnPStoveToCounter,185",
    "TurnOffMicrowave,217",
    "TurnOffSinkFaucet,219",
    "TurnOffStove,47",
    "TurnOnMicrowave,164",
    "TurnOnSinkFaucet,175",
    "TurnOnStove,167",
    "TurnSinkSpout,227",
)
...
SCRIPT="
    WANDB_PROJECT=gr00t-sil-finetune-24 \
    python scripts/gr00t_finetune.py \
    --base_model_path ${CKPT_PATH} \
    --dataset-path "${dataset_path}" \
    --num-gpus ${NUM_GPUS} \
    --output-dir "${BASE_PATH}/ckpts/24task/SIL_bs${TOTAL_BATCH_SIZE}_step${STEPS}_demo${NUM_DEMOS}" \
    --max-steps "${STEPS}" \
