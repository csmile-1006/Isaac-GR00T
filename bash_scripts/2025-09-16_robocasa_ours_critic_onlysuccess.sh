#!/bin/bash                                                                                                                                                  
#SBATCH --job-name=critic_grn15_rc_succ
#SBATCH --output=/home/changyeon/slurm-logs/critic_grn15_rc_succ/%j.out  # log                                                                                                   
#SBATCH --error=/home/changyeon/slurm-logs/critic_grn15_rc_succ/%j.err   # log                                                                                                   
...
RUN_NAME=OURS_Critic_${CKPT_TYPE}_as${CRITIC_ACTION_HORIZON}_e${EXPECTILE}_d1${DISCOUNT1}_d2${DISCOUNT2}_bs${TOTAL_BATCH_SIZE}_steps${RUN_NAME}_dm${NUM_DEMOS}_roll${NUM_ROLLOUTS}_succ
