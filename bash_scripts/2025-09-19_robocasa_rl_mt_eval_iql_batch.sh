#!/bin/bash                                                                                                                                                  
#SBATCH --job-name=eval_grn15_rc_iql_mt
#SBATCH --output=/home/changyeon/slurm-logs/eval_grn15_rc_iql_mt/%A_%a.out  # log
#SBATCH --error=/home/changyeon/slurm-logs/eval_grn15_rc_iql_mt/%A_%a.err   # log
