...
HYPERPARAMS=(
    ...
    # "30000,${N_SAMPLES},0.1"
    # "60000,${N_SAMPLES},0.1"
    "${CRITIC-CHECKPOINT},${N_SAMPLES},0"
    "${CRITIC-CHECKPOINT},${N_SAMPLES},1.0"
    "${CRITIC-CHECKPOINT},$((N_SAMPLES * 2)),0"
    "${CRITIC-CHECKPOINT},$((N_SAMPLES * 2)),1.0"
    "${CRITIC-CHECKPOINT},$((N_SAMPLES * 5)),0"
    "${CRITIC-CHECKPOINT},$((N_SAMPLES * 5)),1.0"
)
