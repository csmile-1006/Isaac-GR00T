#!/bin/bash                                                                                                                                                  
#SBATCH --job-name=scritic_grn15_rc_24
#SBATCH --output=/home/changyeon/slurm-logs/scritic_grn15_rc_24/%A_%a.out  # log                                                                                                   
#SBATCH --error=/home/changyeon/slurm-logs/scritic_grn15_rc_24/%A_%a.err   # log                                                                                                   
