#!/bin/bash                                                                                                                                                  
#SBATCH --job-name=fk_center_sil                                                                                                                                 
#SBATCH --output=/home/changyeon/slurm-logs/fk_center_sil/%A_%a.out  # log                                                                                                   
#SBATCH --error=/home/changyeon/slurm-logs/fk_center_sil/%A_%a.err   # log                                                                                                   
...
script="
    ...
    python scripts/gr00t_finetune.py \
        ...
        --num-gpus ${NUM_GPUS} \
        --output-dir ${BASE_PATH}/franka_ckpts/center_num10/SIL_bs${TOTAL_BATCH_SIZE}_step${STEPS}_demo${NUM_DEMOS} \
        --max-steps ${STEPS} \
