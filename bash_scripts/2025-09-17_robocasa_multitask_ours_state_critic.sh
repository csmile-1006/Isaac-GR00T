#!/bin/bash                                                                                                                                                  
#SBATCH --job-name=scritic_grn15_rc_mt
#SBATCH --output=/home/changyeon/slurm-logs/scritic_grn15_rc_mt/%j.out  # log                                                                                                   
#SBATCH --error=/home/changyeon/slurm-logs/scritic_grn15_rc_mt/%j.err   # log                                                                                                   
