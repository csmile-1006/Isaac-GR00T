...
RUN_NAME=OURS_BoN_as${CRITIC_ACTION_HORIZON}_d1${DISCOUNT1}_d2${DISCOUNT2}_n${NUM_SAMPLES}_bs${TOTAL_BATCH_SIZE}_steps${RUN_NAME}_dm${NUM_DEMOS}_roll${NUM_ROLLOUTS}
