#!/bin/bash                                                                                                                                                  
#SBATCH --job-name=allft_gr00tn15_rc_single
#SBATCH --output=/home/changyeon/slurm-logs/allft_gr00tn15_rc_single/%j.out  # log                                                                                                   
#SBATCH --error=/home/changyeon/slurm-logs/allft_gr00tn15_rc_single/%j.err   # log                                                                                                   
