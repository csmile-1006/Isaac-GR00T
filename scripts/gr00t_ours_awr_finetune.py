...
def main(config: ArgsConfig):
    ...
    # ------------ step 2: load model ------------
    model = GR00T_N1_5_Ours_AWR.from_pretrained(
    ...
    scheduler = LambdaLR(
        optimizer,
        lr_lambda=[cosine_warmup_lambda, constant_lambda, constant_lambda],  # param_groups 순서와 매칭
    )
...
if __name__ == "__main__":
    ...
    os.environ["WANDB_PROJECT"] = "gr00t-ours-awr-finetune"
    wandb.init(
