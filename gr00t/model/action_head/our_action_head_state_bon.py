...
@dataclass
class OurActionHeadStateBoNConfig(PretrainedConfig):
...
class OurActionHeadStateBoN(nn.Module):
    config_class = OurActionHeadStateBoNConfig
    supports_gradient_checkpointing = True

    def __init__(
        self,
        config: OurActionHeadStateBoNConfig,
    ):
        super().__init__()
