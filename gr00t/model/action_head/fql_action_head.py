...
class FQLActionHead(nn.Module):
    ...
    def compute_critic_loss(
        ...
        action = self.get_action_for_critic(backbone_output, action_input)["action_pred"]
        q1, q2 = self.critic(
    ...
    def get_action_for_critic(self, backbone_output: BatchFeature, action_input: BatchFeature) -> BatchFeature:
        backbone_output = self.process_backbone_output(backbone_output)
