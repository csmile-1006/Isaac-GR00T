...
@dataclass
class OurCriticConfig(PretrainedConfig):
...
class OurCritic(nn.Module):
    config_class = OurCriticConfig
    supports_gradient_checkpointing = True

    def __init__(
        self,
        config: OurCriticConfig,
    ):
        super().__init__()
        ...
        self.set_trainable_parameters(
            config.tune_value, config.tune_critic
        )

    def set_trainable_parameters(
        self, tune_value: bool, tune_critic: bool
    ):
