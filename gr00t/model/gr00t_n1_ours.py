...
from .action_head.our_action_head import (
    OurActionHead,
    OurActionHeadConfig,
)
...
# config
@dataclass
class GR00T_N1_5_Ours_Config(PretrainedConfig):
    model_type = "gr00t_n1_5_ours"
...
# real model
class GR00T_N1_5_Ours(PreTrainedModel):
    supports_gradient_checkpointing = True
    config_class = GR00T_N1_5_Ours_Config
    """
    ...
    def __init__(
        ...
        action_head_cfg = OurActionHeadConfig(**config.action_head_cfg)
        self.action_head = OurActionHead(action_head_cfg)
    ...
    def from_pretrained(
        ...
        **kwargs,
        ...
        if not from_gr00t_n1_5:
            ...
            new_cfg = GR00T_N1_5_Ours_Config()
            ...
            action_head_cfg = OurActionHeadConfig(**pretrained_gr00t_n1_5_cfg["action_head_cfg"])
...
# register
AutoConfig.register("gr00t_n1_5_ours", GR00T_N1_5_Ours_Config)
AutoModel.register(GR00T_N1_5_Ours_Config, GR00T_N1_5_Ours)
