...
from .action_head.our_action_head_awr import (
    OurActionHeadAWR,
    OurActionHeadAWRConfig,
)
...
# config
@dataclass
class GR00T_N1_5_Ours_AWR_Config(PretrainedConfig):
    model_type = "gr00t_n1_5_ours_awr"
...
# real model
class GR00T_N1_5_Ours_AWR(PreTrainedModel):
    supports_gradient_checkpointing = True
    config_class = GR00T_N1_5_Ours_AWR_Config
    """
    ...
    def __init__(
        self,
        config: GR00T_N1_5_Ours_AWR_Config,
        ...
        action_head_cfg = OurActionHeadAWRConfig(**config.action_head_cfg)
        self.action_head = OurActionHeadAWR(action_head_cfg)
    ...
    def validate_data(self, action_head_outputs, backbone_outputs, next_backbone_outputs=None, is_training=True):
        ...
        fail_action_head = (not isinstance(action_head_outputs, BatchFeature)) or not (
            ...
            or (
                ...
                == self.critic_action_horizon  # Ours must output single action which is based on policy gradient
    ...
    def from_pretrained(
        ...
        **kwargs,
        ...
        if not from_gr00t_n1_5:
            ...
            new_cfg = GR00T_N1_5_Ours_AWR_Config()
            ...
            action_head_cfg = OurActionHeadAWRConfig(**pretrained_gr00t_n1_5_cfg["action_head_cfg"])
...
# register
AutoConfig.register("gr00t_n1_5_ours_awr", GR00T_N1_5_Ours_AWR_Config)
AutoModel.register(GR00T_N1_5_Ours_AWR_Config, GR00T_N1_5_Ours_AWR)
