...
from .action_head.our_critic import (
    OurCritic,
    OurCriticConfig,
)
...
# config
@dataclass
class GR00T_N1_5_Ours_Critic_Config(PretrainedConfig):
...
# real model
class GR00T_N1_5_Ours_Critic(PreTrainedModel):
    supports_gradient_checkpointing = True
    config_class = GR00T_N1_5_Ours_Critic_Config
    """
    ...
    def __init__(
        self,
        config: GR00T_N1_5_Ours_Critic_Config,
        ...
        critic_cfg = OurCriticConfig(**config.critic_cfg)
        self.critic_head = OurCritic(critic_cfg)
    ...
    def from_pretrained(
        ...
        **kwargs,
        ...
        if not from_gr00t_n1_5:
            ...
            new_cfg = GR00T_N1_5_Ours_Critic_Config()
            ...
            critic_cfg = OurCriticConfig(**pretrained_gr00t_n1_5_cfg["action_head_cfg"])
...
# register
AutoConfig.register("gr00t_n1_5_ours_critic", GR00T_N1_5_Ours_Critic_Config)
AutoModel.register(GR00T_N1_5_Ours_Critic_Config, GR00T_N1_5_Ours_Critic)
