...
class DataCollectionWrapper(Wrapper):
    def __init__(self, env, directory, collect_freq=1, flush_freq=100):
        ...
        Args:
            ...
            collect_freq (int): How often to save simulation observation, in terms of environment steps.
        ...
        # in-memory cache for simulation observations and action info
        self.states = []
        self.observations = []
    ...
    def _on_first_interaction(self):
        ...
        self.observations.append(self._get_observations())
    ...
    def step(self, action):
        ...
        # collect the current simulation observation if necessary
